...
**************************************************************************
  METHOD getDaysToFlight.
    DATA:
      c_booking_entity TYPE ZRAP110_C_BookingTP_030,
      bookings_result  TYPE TABLE FOR FUNCTION RESULT zrap110_r_traveltp_030\\booking~getdaystoflight,
...
*         ALL FIELDS
    ...
    LOOP AT bookings ASSIGNING FIELD-SYMBOL(<booking>).
      ...
      booking_result-%param
        = CORRESPONDING #( zrap110_calc_book_elem_030=>calculate_days_to_flight( c_booking_entity )
