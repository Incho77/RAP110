...
define root view entity ZRAP110_C_TRAVELTP_030
  provider contract transactional_query
  as projection on ZRAP110_R_TRAVELTP_030
{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_TRAV_ELEM_030'
  ...
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZRAP110_C_BOOKINGTP_030,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
