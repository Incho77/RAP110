...
define view entity ZRAP110_R_BOOKINGTP_030
  as select from ZRAP110_ABOOK030 as Booking
  association to parent ZRAP110_R_TRAVELTP_030 as _Travel on $projection.TravelID = _Travel.TravelID
